"""Fused gated residual kernel: out = residual + x * gate.

Replaces 2 separate TTNN ops (mul, add) with a single fused kernel.
Used after attention and FFN in each MMDiT block.
All tensors are 2D [S, D].
"""
import ttl
...
def make_gated_residual_kernel():
    """Create a gated residual kernel for 2D [S, D] tensors."""
