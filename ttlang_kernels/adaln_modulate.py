"""Fused adaLN modulate kernel: out = x * (scale + 1) + shift.

Replaces 3-4 separate TTNN ops (add, mul, add) with a single fused kernel.
Adapted from oasis-ttlang for Qwen-Image dimensions.
"""
import ttl

TILE = 32
ELEM_GRAN = 8  # Process 8 tiles wide per iteration for throughput
